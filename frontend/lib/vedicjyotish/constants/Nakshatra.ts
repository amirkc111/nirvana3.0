...
export const NakshatraDetails: Record<NakshatraEn, NakshatraDetail> = {
    Ashwini: {
        nakshatra_num: 1,
        lord: "Ketu",
        name: { hindi: "अश्विनी", english: "Ashwini" },
    },
    Bharani: {
        nakshatra_num: 2,
        lord: "Venus",
    ...
    Mrigashirsha: {
        nakshatra_num: 5,
        lord: "Mars",
        name: { hindi: "मृगशिरा", english: "Mrigashirsha" },
    },
    Ardra: {
        nakshatra_num: 6,
        lord: "Rahu",
    ...
    "Purva Phalguni": {
        nakshatra_num: 11,
        lord: "Venus",
        name: { hindi: "पू.फाल्गुनी", english: "Purva Phalguni" },
    },
    "Uttara Phalguni": {
        nakshatra_num: 12,
        lord: "Sun",
        name: { hindi: "उ.फाल्गुनी", english: "Uttara Phalguni" },
    },
    Hasta: {
        nakshatra_num: 13,
        lord: "Moon",
    ...
    Moola: {
        nakshatra_num: 19,
        lord: "Ketu",
        name: { hindi: "मूल", english: "Moola" },
    },
    "Purva Ashadha": {
        nakshatra_num: 20,
        lord: "Venus",
        name: { hindi: "पू.षाढ़ा", english: "Purva Ashadha" },
    },
    "Uttara Ashadha": {
        nakshatra_num: 21,
        lord: "Sun",
        name: { hindi: "उ.षाढ़ा", english: "Uttara Ashadha" },
    },
    Shravana: {
        nakshatra_num: 22,
        lord: "Moon",
        name: { hindi: "श्रवण", english: "Shravana" },
    },
    Dhanishta: {
        nakshatra_num: 23,
        lord: "Mars",
    ...
    "Purva Bhadrapada": {
        nakshatra_num: 25,
        lord: "Jupiter",
        name: { hindi: "पू.भाद्रपद", english: "Purva Bhadrapada" },
    },
    "Uttara Bhadrapada": {
        nakshatra_num: 26,
        lord: "Saturn",
        name: { hindi: "उ.भाद्रपद", english: "Uttara Bhadrapada" },
    },
    Revati: {
        nakshatra_num: 27,
        lord: "Mercury",
