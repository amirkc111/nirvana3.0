...
function calculate() {//Called when 'calculate' button is pressed.
	...
	// Clean output: Just the table
	document.write(getUduDasa(params['desc'], params['sphuta'], params['datetime'], params['dasha'], params['eventdatetime'], params['antaradasha'], params['ayush'], params['starting']).html);
	document.close();
}
