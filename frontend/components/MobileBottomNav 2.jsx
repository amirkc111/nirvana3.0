...
export default function MobileBottomNav() {
    ...
    // Hide on admin/guru pages, active chat sessions, and login page
    if (pathname === '/login' || pathname?.startsWith('/admin') || pathname?.startsWith('/guru') || pathname?.startsWith('/chat/')) return null;
